...
class Cupage  extends Model
{
    ...
    {
        if ($page>0 and $page<=$this->total_pages){
            switch ($this->method) {
                case'ajax':
                    $parameter = '';
                    if ($this->parameter) {
                     ...
                     $r = '<a onclick="' . $this->ajax_func_name . '(\'' . $page . '\'' . $parameter . ')" href="javascript:void(0)">' . $text . '</a>' . "\n";
                ...
                default:
                    $r =  '<a href="' . $this->_get_url($page) . '">' . $text . '</a>' . "\n";
                    break;
            }
        }else{
             $r = '<span>' . $text . '</span>' . "\n";
