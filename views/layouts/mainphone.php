...
<?if($this->params['data']==10):?>
<iframe id="caijian" src="" border="0" frameborder="0" style=" z-index: 999999;position: absolute;top: 0;left: 0;width: 100%;height: 100%;display: none"></iframe>
<?endif;?>
<!--侧滑菜单部分-->
<aside  class="menuBg">
    <?php
    ...
    <article class="menuCen" >
        ...
        <section class="menuUl">
            <ul>
                <?if(Yii::$app->user->identity->RoleID==1 || Yii::$app->user->identity->RoleID==2 || Yii::$app->user->identity->RoleID==4):?>
                <?if(Yii::$app->user->identity->RoleID==1):?>
                ...
                <li <?if($data==11):?>class="menuActive"<?endif;?>>
                    <a href="?r=teachmanage/teachmanage">
                        <figure>
                            <img <?if($data==11):?>src="assets/images/phone/images/gicon_ff.png"<?else:?>src="assets/images/phone/images/gicon_f.png"<?endif;?>">
                            <figcaption>答疑管理</figcaption>
                        </figure>
                    </a>
                </li>
                <?endif;?>
                <?if(Yii::$app->user->identity->RoleID==3):?>
                    ...
                    <li <?if($data==10):?>class="menuActive"<?endif;?>>
                        <a href="?r=student/answermanage">
                            <figure>
                                <img <?if($data==10):?>src="assets/images/phone/dayi/icon_cc_10.png"<?else:?>src="assets/images/phone/dayi/icon_cca_10.png"<?endif;?>">
                                <figcaption>答疑室</figcaption>
                            </figure>
                        </a>
                    </li>
                <?endif;?>
                <?if(Yii::$app->user->identity->RoleID==1):?>
                <li <?if($data==9):?>class="menuActive"<?endif;?>>
                    <a href="?r=admin/answermanage">
                        <figure>
                            <img <?if($data==9):?>src="assets/images/phone/dayi/icon_dygl.png"<?else:?>src="assets/images/phone/dayi/icon_dygla.png"<?endif;?>">
                            <figcaption>答疑管理</figcaption>
                        </figure>
                    </a>
                </li>
